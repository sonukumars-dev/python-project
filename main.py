...
class Face_Recognition_System:
    def __init__(self,root):
      ...
      self.root.title("Autonomous Thermal Screening and Integrated Attendance Catalouging System")
      ...
      title_lbl=Label(bg_img,text="Autonomous Thermal Screening and Integrated Attendance Catalouging System", font=("Times New Roman", 30, "bold"), bg="white", fg="red")
      ...
      #Developer
      img7=Image.open(r"Images/thermal_detection.jpg")
    ...
    def open_img(self):
      #os.open("ImagesAttendance",'r')
      os.system('xdg-open "%s"' % "ImagesAttendance")
